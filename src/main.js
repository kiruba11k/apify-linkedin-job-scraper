...
const crawler = new PuppeteerCrawler({
    minConcurrency: 2,
    maxConcurrency: 5,
    proxyConfiguration: await Actor.createProxyConfiguration({ groups: ['RESIDENTIAL'] }).catch(() => null),
